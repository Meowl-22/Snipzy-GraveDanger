...
// Function to refresh current active outfit based on obj_player state
refresh_selected_outfit = function() {
    if (!instance_exists(obj_player)) return;
    
    switch (obj_player.pal_select) {
        case 0: case 1: case 2: case 13: case 14: clothes_selected = 0; break;
...
// Action Button Navigation Variables
button_selected = 0;    // 0 = WEAR, 1 = EXIT
in_button_mode = false;  // false = outfit carousel, true = selecting buttons
btn_scale_0 = 1;        // Pop scale for WEAR button
btn_scale_1 = 1;        // Pop scale for EXIT button