...
var _current_tv = tvs[cur_selected - 1];
var _save = _current_tv.save_exists;

// Grabs percentage from save file dynamically
per = floor(menu_get_file_percentage(_current_tv.filename));

draw_sprite(spr_menustatus, 0, 183, 312);
global.draw_bignumber_counter(196, 326, per);

var _ix = floor(per / 14.285714285714286); 
_ix = min(_ix, 7);
