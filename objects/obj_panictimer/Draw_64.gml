...
// =========================================================================
// ADDED: ROCKING & BOUNCING LOGIC FOR JOHN
// =========================================================================
// Rocking angle: oscillates between -15 and +15 degrees
var john_angle = sin(current_time * 0.01) * 15;

// Bouncing offset: oscillates upward up to 10 pixels. 
// abs() creates a rhythmic, snappy bounce off the surface floor.
var john_bounce_y = -abs(sin(current_time * 0.008)) * 10;

// Replaced draw_sprite with draw_sprite_ext to support rotation (angle)
draw_sprite_ext(
	spr_timer_john, 
	john.image_index, 
	(x - 150) + barpos, 
