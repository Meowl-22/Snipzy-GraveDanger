...
{
	return instance_create_depth(_x, _y, 1, obj);
}
...
function set_globals()
{
	...
	global.option_joysuperjump = ini_read_real("options", "joysuperjump", true)
	...
	pal_swap_init_system(shd_pal_swapper, shd_pal_swapper, shd_pal_swapper)
...
{
	return global.level_data.treasure && global.combo.wasted == false && global.level_data.lap2 && global.level_data.secret_count >= 3;
}
...
function reset_level()
{
	...
	global.secret = false
	global.hurtcounter = 0
	var _ln = global.level_data.level_name
	global.level_data = {
		treasure: false,
		level_name: _ln,
		secret_count: 0,
